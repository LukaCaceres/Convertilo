                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            {inquiryTypes.map((type) => (
                                                <label
                                                    key={type.value}
                                                    className={`relative flex flex-col p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 ${formData.type === type.value
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-3 mb-2">
                                                        <div
                                                            className={`${formData.type === type.value ? "text-blue-500" : "text-gray-400"
                                                                } transition-colors duration-200`}
                                                        >
                                                            {type.icon}
                                                        </div>
                                                        <span
                                                            className={`font-medium ${formData.type === type.value ? "text-blue-700" : "text-gray-700"
                                                                }`}
                                                        >
                                                            {type.label}
                                                        </span>
